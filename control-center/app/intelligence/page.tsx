...
export default function IntelligencePage() {
  ...
  const readiness = [
    ...
    { label: "Realized outcome labels", state: false, detail: "business DB ready; no real outcomes logged", icon: BrainCircuit },
    { label: "Account eligibility", state: false, detail: "Listings Restrictions SP-API not connected", icon: CheckCircle2 },
    { label: "Model promotion evidence", state: false, detail: "needs both good and bad realized labels", icon: GitCompareArrows },
  ];
